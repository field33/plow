...
use plow_package_management::edit::{AddDependency, EditOperation, RemoveDependency, UpdateDependency};
...
fn metadata_with_dependency() {
    ...
    assert_eq!(dep.full_name, "other_ontology");
...
fn add_dependency() {
    ...
    let add_operation = AddDependency {
        ...
        dependency: Dependency::<SemanticVersion>::try_from("new_dependency =0.1.2").unwrap(),

        dependency_ontology_iri: "http://field33.com/ontologies/new_dependency/".to_string(),
    };
...
fn remove_dependency() {
    ...
    let remove_operation = RemoveDependency {
        ontology_iri: "http://field33.com/ontologies/core_change_tracking/".to_string(),
        dependency_name: "other_ontology".to_string(),
    };
...
fn update_dependency() {
    ...
    let update_operation = UpdateDependency {
        ontology_iri: "http://field33.com/ontologies/core_change_tracking/".to_string(),
        dependency: Dependency::<SemanticVersion>::try_from("other_ontology =20.0.0").unwrap(),
        dependency_ontology_iri: "http://field33.com/ontologies/other_ontology/".to_string(),
    };
