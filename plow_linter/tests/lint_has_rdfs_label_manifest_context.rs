...
rdf:type owl:NamedIndividual ."
    ...
    linter_a.add_lint(Box::new(HasRdfsLabelManifestContext::default()) as PlowLint);
    let mut linter_b = Linter::try_from(ttl_document_with_rdfs_label_b.as_ref()).unwrap();
    linter_b.add_lint(Box::new(HasRdfsLabelManifestContext::default()) as PlowLint);
    let mut linter_c = Linter::try_from(ttl_document_with_rdfs_label_c.as_ref()).unwrap();
    linter_c.add_lint(Box::new(HasRdfsLabelManifestContext::default()) as PlowLint);
    let mut linter_d = Linter::try_from(ttl_document_with_rdfs_label_d.as_ref()).unwrap();
    linter_d.add_lint(Box::new(HasRdfsLabelManifestContext::default()) as PlowLint);
    let mut linter_e = Linter::try_from(ttl_document_with_rdfs_label_e.as_ref()).unwrap();
    linter_e.add_lint(Box::new(HasRdfsLabelManifestContext::default()) as PlowLint);
    let mut linter_f = Linter::try_from(ttl_document_with_rdfs_label_f.as_ref()).unwrap();
    linter_f.add_lint(Box::new(HasRdfsLabelManifestContext::default()) as PlowLint);
